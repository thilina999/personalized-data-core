...
public class ExternalController {
    ...
    public ResponseEntity<List<ProductMetadataDTO>> getProductsByShopper(
        ...
        final List<ProductMetadataDTO> products = externalService.getProductsByShopper(shopperId, category, brand, limit);
